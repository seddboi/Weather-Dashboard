...
function newWeatherInfo(cityEntry) {
    if (cityEntry !== '') {
        var adjustedAPI = urlWeather + cityEntry;
    } 
    ...
    $.ajax ({url: adjustedAPI, method: 'GET'}).then(function(response) {
        ...
        // var urlUVIndex = 'https://api.openweathermap.org/data/2.5/onecall?lat='+lat+'&lon='+lon+'&appid=bc4962a699e8e59af6dee3b499b23da2';
        ...
        $.ajax ({url: urlForecast+cityName, method: 'GET'}).then(function(response){
            console.log(response);
